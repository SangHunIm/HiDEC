...
class AccuracyThresh(Metric):
    ...
    def value(self):
        ...
        acc = ((self.y_pred>self.thresh)==self.y_true.bool()).float().cpu().numpy().sum()
...
if __name__ == "__main__":
    ...
    tr_acc.update(tr.value(), n=a.size(0))
    tr_f1.update(f1.value(), n=a.size(0))
